...
3. Open this link in Safari and tap **Install**:  
   **[Install Search-Only YouTube](https://raw.githubusercontent.com/jakedarrow/search-only-youtube/main/search-only-youtube.user.js)**
...
2. Open the install link and confirm:  
   **[Install Search-Only YouTube](https://raw.githubusercontent.com/jakedarrow/search-only-youtube/main/search-only-youtube.user.js)**  
*(Alternatively, Chrome users can load the unpacked `extension` folder via `chrome://extensions`).*
